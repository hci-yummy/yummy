<template>
  <el-tabs type="border-card" v-model="choice" @tab-click="handleAddressClick" style="width: 400px;min-height: 200px">
    <el-tab-pane label="省" name="first" class="tab-style">
      <div style="width: 360px;min-height: 200px;">
        <div style="display: inline-block; height: 35px; width: 72px" v-for="item in address" :key="item.key">
          <el-button size="mini" @click="setProvince(item.name)">{{item.name}}</el-button>
        </div>
      </div>
    </el-tab-pane>
    <el-tab-pane label="市" name="second" class="tab-style">
      <div style="width: 360px;min-height: 200px;">
        <div v-if="province === ''">
          请先选择您所在的省！
        </div>
    ...
    <el-tab-pane label="区/镇" name="third" class="tab-style">
      <div style="width: 360px;min-height: 200px;">
        <div v-if="city === ''">
          请先选择您所在的市！
        </div>
        ...
        methods:{
          ...
          setProvince(provinceChoice){
            ...
            for(var i=0; i< this.address.length; i++){
              if(this.address[i].name === provinceChoice){
          ...
          setCity(cityChoice){
            ...
            for(var i=0; i< this.all_cities.length; i++){
              if(this.all_cities[i].name === cityChoice){
